...
def get_args():
    ...
    parser.add_argument("--join", type=str, help="Join string for textual class")
    ...
    parser.add_argument("--fp16", type=bool, default=False, help="Whether to activate mixed precision")
